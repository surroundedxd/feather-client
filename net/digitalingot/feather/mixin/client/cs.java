...
public class cs extends VertexLighterFlat
{
    ...
    protected void updateLightmap(final float[] array, final float[] array2, float n, float n2, float n3) {
        ...
        array2[0] = MathHelper.func_76131_a(n36, 0.0f, 0.0073243305f);
        array2[1] = MathHelper.func_76131_a(n37, 0.0f, 0.0073243305f);
    }
}
